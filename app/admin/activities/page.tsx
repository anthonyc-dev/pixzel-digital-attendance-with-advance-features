        ...
        <div className="flex flex-col gap-4 sm:gap-6 lg:gap-8 w-full max-w-7xl animate-in fade-in duration-200 ease-out pb-4 sm:pb-6 lg:pb-10">
            ...
            <header className="flex flex-wrap items-start sm:items-end justify-between gap-4">
                <div className="space-y-1 sm:space-y-2">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tighter text-foreground">Activity Logs</h1>
                    <p className="text-muted-foreground text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] leading-none opacity-80">Track and manage daily attendance activities</p>
                </div>
                <button className="flex items-center gap-1.5 sm:gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-secondary text-white rounded-lg sm:rounded-xl font-black uppercase tracking-widest text-[9px] sm:text-[10px] shadow-xl shadow-secondary/20 hover:scale-[1.03] active:scale-[0.97] transition-all w-fit">
            ...
            <section className="flex flex-col gap-4 sm:gap-6">
                ...
                <div className="flex flex-wrap items-start md:items-center justify-between gap-3 sm:gap-4">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full md:w-auto">
                        <div className="flex items-center gap-1.5 sm:gap-2 p-1 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 rounded-lg">
                            {['Leave', 'Absent', 'Active'].map(f => (
                                <span key={f} className="px-2.5 sm:px-4 py-1.5 sm:py-2 bg-white dark:bg-white/5 text-[9px] sm:text-[10px] font-black text-foreground/50 uppercase tracking-widest rounded-md sm:rounded-lg shadow-sm border border-gray-100 dark:border-white/5 flex items-center gap-1 sm:gap-2 hover:bg-gray-100 dark:hover:bg-white/[0.08] hover:text-foreground cursor-pointer transition-all">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-end">
                        <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg sm:rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-foreground/70 hover:bg-gray-50 dark:hover:bg-white/10 hover:text-foreground transition-all shadow-sm group">
                ...
                <div className="w-full bg-white dark:bg-white/[0.02] border border-gray-100 dark:border-white/5 rounded-xl sm:rounded-2xl overflow-hidden shadow-xl dark:shadow-2xl overflow-x-auto">
                    {loading ? (
                                    ...
                                    <tr key={i}>
                                        <td className="p-4 sm:p-5 md:p-7">
                                            <div className="flex items-center gap-3 sm:gap-5">
                                                <div className="w-10 h-10 sm:w-12 h-12 md:w-14 h-14 bg-gray-200 dark:bg-white/10 rounded-lg sm:rounded-xl animate-pulse" />
                                                <div className="space-y-2">
                                        ...
                                        {[...Array(7)].map((_, j) => (
                                            <td key={j} className="p-4 sm:p-5 md:p-7 border-l border-gray-100 dark:border-white/5">
                                                <div className="h-8 w-24 bg-gray-100 dark:bg-white/5 rounded-xl animate-pulse mx-auto" />
                                            </td>
                                        ))}
                                    </tr>
                                ))}
                                    ...
                                    <tr key={emp.id} className="group hover:bg-gray-50 dark:hover:bg-white/[0.03] transition-all">
                                        <td className="p-4 sm:p-5 md:p-7">
                                            <div className="flex items-center gap-3 sm:gap-5">
                                                <div className="relative">
                                                    {emp.image ? (
                                                        <Image src={emp.image} alt={emp.employer_name} width={56} height={56} className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl transition-all duration-500 border border-gray-100 dark:border-white/10 shadow-lg group-hover:shadow-secondary/20" unoptimized />
                                                    ) : (
                                                        <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-lg font-black text-gray-500">
                                        ...
                                        {days.map((_, j) => (
                                            <td key={j} className="p-4 sm:p-5 md:p-7 border-l border-gray-100 dark:border-white/5 relative group/cell">
                                                ...
                                                <div className={cn(
                                                    "mt-4 sm:mt-5 mx-auto flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-md sm:rounded-xl text-[8px] sm:text-[9px] font-black uppercase tracking-widest transition-all shadow-sm ring-1 ring-inset",
