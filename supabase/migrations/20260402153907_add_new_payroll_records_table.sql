...
CREATE INDEX idx_payroll_records_employer_registration_id
ON payroll_records(employer_registration_id);

CREATE INDEX idx_payroll_records_processed_at
ON payroll_records(processed_at DESC);